...
function buildTemplateDraftPrompt({ lead, recipientName = "", template = "", websiteContent = "" } = {}) {
  ...
  return [
    ...
    "- [specific observation pain point based on data]: Write ONE crisp sentence naming a specific manual process or workflow gap this company has that software or AI can fix.",
    "  Derive it from: (1) what companies in this exact niche typically do manually that should be automated, and (2) specific signals in the company context and website content.",
    "  The pain must be something our services can directly solve — automation, AI, custom tooling.",
    "  Format: 'manually [doing X] across [Y]' or 'handling [Z] without any automation layer' or 'no centralised system for [process]'.",
    "  Never use vague phrases like 'struggle with growth' or 'face challenges'.",
    "- [AssetName ...]: Name a specific demo PDF that shows how we'd solve their exact problem.",
    "  Format: '[Company or Problem] [AI/Automation Solution Type] Demo' — 4-7 words, reads like a real document name.",
    "  It must directly match the pain above. Examples: 'United Insurance Carrier Workflow Automation Demo', 'Claims Processing AI Agent Demo', 'Policy Coordination Admin Panel Demo'.",
