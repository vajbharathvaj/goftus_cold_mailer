...
function buildPrompt({ rowNumber, websiteUrl, jinaContent, sourceRow }) {
  return [
    ...
    "- painHypothesis: The most important field. Write ONE sharp, specific sentence naming a concrete process or workflow problem this company has that software, AI, or automation can directly fix.",
    "  Our services: workflow automation, AI agents, RAG systems, business AI software, custom admin panels, custom internal tools, database organisation, cloud development.",
    "  How to derive it:",
    "  Step 1 — Identify the most common manual/inefficient process in this exact niche that is typically solved with software or AI.",
    "  Step 2 — Find specific signals in the website text: repetitive tasks, manual coordination, data silos, missing tooling, scale without automation.",
    "  Step 3 — Write ONE observation that names the specific process gap and makes it clear automation is the fix.",
    "  Write as a direct observation, e.g. 'They are manually [X] across [Y] offices with no centralised system' or 'Their [workflow] has no automation layer, meaning [team] handles [task] by hand at scale'.",
    "  Do NOT write a question. Do NOT use vague phrases like 'struggle with growth'. The pain must be something our software/AI services can solve.",
